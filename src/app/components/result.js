  ...
  return (
    <>
      <div className="h-screen w-full">
        ...
        <p className="flex justify-center text-16px font-normal text-dark_grey  max-sm:pl-4 max-sm:mt-4 max-sm:text-center">
          Lorem ipsum dolor sit amet, consectetur adipiscing elit. Diam, dapibus
          mattis vel feugiat erat tortor eleifend.
        </p>
        <div data-aos="flip-down">
          <div className="grid grid-cols-4 gap-28 mt-12 max-sm:grid-cols-2 max-sm:gap-20 max-sm:pl-6 max-sm:mt-16">
